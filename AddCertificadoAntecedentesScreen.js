...
// create a component
const AddCertificadoAntecedentesScreen = ({route, navigation}) => {
    ...
    const [certificado, setCertificado] = React.useState(route.params.ImgCertificado);      
    ...
    rendCertificado = () =>{
      console.log(certificado)
        if(certificado){
          const externalLink = `https://convey.cl/partner/certificadosantecedentes/${certificado}`;
    ...
    React.useEffect(() => {
      ...
      passBack = () =>{
        navigation.navigate('CertificadoAntecedentes')
      }
      ...
      const AddCertificado = () =>{
        ...
        fetch(`${ServidorExport}/partner/CrearCertificado.php`, {
          method: 'POST',
          headers: {
      ...
      const EditCertificado = () => {
          ...
          fetch(`${ServidorExport}/partner/EditarCertificado.php`, {
            method: 'POST',
            headers: {
              Accept: 'application/json',
              'Content-Type': 'multipart/form-data',
      ...
      >
            ...
            <ScrollView style={{flex:1}} keyboardShouldPersistTaps='always'>
              ...
              <View style={styles.header}>
               ...
               <Text style={styles.TextHeader}>{route.params.Nombre != '' ? 'Editar Certificado de antecedentes' : 'Agregar Certificado de antecedentes'}</Text>
                ...
                <TouchableOpacity style={{width:'100%', backgroundColor:'#E6E6FA', borderRadius:10, padding:10, justifyContent:'center', alignItems:'center', marginBottom:15, marginTop:15}} onPress={() => {openSelectMethodImage('Certificado')}}>
                ...
                {rendCertificado()}
                    ...
                    <TouchableOpacity style={{width:'100%', height:'100%', justifyContent:'center', alignItems:'center'}} activeOpacity={1} onPress={() => EditCertificado()}>
...
export default AddCertificadoAntecedentesScreen;
