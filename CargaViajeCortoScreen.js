...
// create a component
const CargaViajeCortoScreen = ({route, navigation}) => {
  const socket = getSocket();
    ...
    fetchCargaViajeLargo = async (x) => {
      console.log('ixx')
      console.log(idCarga)
        await fetch(`${ServidorExport}/partner/viajecorto/TraerCargaUnicaViajeCorto.php`, {
           method: 'POST',
           headers: {
      ...
      const VistoCamionero = () =>{
        ...
        fetch(`${ServidorExport}/partner/viajecorto/MarcarVistoPago.php`, {
          method: 'POST',
          headers: {
              Accept: "application/json",
      ...
      const cargarViajeCorto = () =>{
        ...
        fetch(`${ServidorExport}/partner/viajecorto/CargarViajeCorto.php`, {
          method: 'POST',
          headers: {
              Accept: "application/json",
              "Content-Type": "multipart/form-data"
      ...
      const EntregarCarga = async () =>{
        ...
        fetch(`${ServidorExport}/partner/viajecorto/EntregarViajeCorto.php`, {
          method: 'POST',
          headers: {
              Accept: "application/json",
              "Content-Type": "multipart/form-data"
...
export default CargaViajeCortoScreen;
