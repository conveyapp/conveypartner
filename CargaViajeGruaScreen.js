...
// create a component
const CargaViajeGruaScreen = ({route, navigation}) => {
  const socket = getSocket();
    ...
    const [bultosSelected, setBultosSelected] = React.useState(false);
    const [aceptoCargaSelected, setAceptoCargaSelected] = React.useState(false)
    const [coment, setComent] = React.useState('')


    const [ruedasSelected, setRuedasSelected] = React.useState(false);
    const [documentosSelected, setDocumentosSelected] = React.useState(false);
    const [espejosSelected, setEspejosSelected] = React.useState(false);
    const [extintorSelected, setExtintorSelected] = React.useState(false);
    const [focosSelected, setFocosSelected] = React.useState(false);
    const [obsText, setObsText] = React.useState(false);
    ...
    fetchCargaViaje = async (x) => {
      console.log('ixx')
      console.log(idCarga)
        await fetch(`${ServidorExport}/partner/viajegrua/TraerCargaUnicaViajeGrua.php`, {
           method: 'POST',
           headers: {
      ...
      const VistoCamionero = () =>{
        ...
        fetch(`${ServidorExport}/partner/viajegrua/MarcarVistoPago.php`, {
          method: 'POST',
          headers: {
              Accept: "application/json",
      ...
      const cargarViajeGrua = () =>{
        ...
        if (ruedasSelected == true) {
            ruedasSend = 'si';
        } else {
            ruedasSend = 'no';
        }
        
        if (documentosSelected == true) {
            documentosSend = 'si';
        } else {
            documentosSend = 'no';
        }
        
        if (espejosSelected == true) {
            espejosSend = 'si';
        } else {
            espejosSend = 'no';
        }
        
        if (extintorSelected == true) {
            extintorSend = 'si';
        } else {
            extintorSend = 'no';
        }
        
        if (focosSelected == true) {
            focosSend = 'si';
        } else {
            focosSend = 'no';
        }
        ...
        data.append('ruedasacept', ruedasSend);
        data.append('documentosacept', documentosSend);
        data.append('espejosacept', espejosSend);
        data.append('extintoracept', extintorSend);
        data.append('focosacept', focosSend);
        ...
        fetch(`${ServidorExport}/partner/viajegrua/CargarViajeGrua.php`, {
          method: 'POST',
          headers: {
              Accept: "application/json",
              "Content-Type": "multipart/form-data"
      ...
      const EntregarCarga = async () =>{
        ...
        fetch(`${ServidorExport}/partner/viajegrua/EntregarViajeGrua.php`, {
          method: 'POST',
          headers: {
              Accept: "application/json",
              "Content-Type": "multipart/form-data"
                        ...
                        <View key={i}>
                                    ...
                                    <View style={{width:'100%', marginRight:15, flexDirection:'row', justifyContent:'space-between', alignItems:'center', backgroundColor:'#fff', padding:8, borderRadius:10, shadowColor: "#000",shadowOffset: {	width: 0,	height: 2,}, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5,}}>
                                        ...
                                        <TextTicker style={{ color: '#262626', fontFamily:'Poppins_700Bold', fontSize: fontWidth / 25,}} duration={5000}
                                            ...
                                            bounce
                                            repeatSpacer={50}
                                            marqueeDelay={2000}>{data.nbultos} Bultos</TextTicker>
                                        </View>
                                    ...
                                    <View style={{flex:1}}>
                                        ...
                                        <TextTicker style={{ color: '#262626', fontFamily:'Poppins_700Bold', fontSize: fontWidth / 25,}} duration={5000}
                                            ...
                                            bounce
                                            repeatSpacer={50}
                                            marqueeDelay={2000}>{data.kl} Kilos</TextTicker>
                                        </View>
                    
                                    </View>

                                    <TouchableOpacity onPress={() => setRuedasSelected(!ruedasSelected)} style={{width:'100%', flexDirection:'row', alignItems:'center', marginBottom:15}}>
                                        <View style={{width:fontWidth/18, height: fontWidth/18, marginRight:10, borderWidth:2, borderColor:'#07E607', borderRadius:100, justifyContent:'center', alignItems:'center'}}>
                                            <View style={{width:fontWidth/28, height: fontWidth/28, borderRadius:100, backgroundColor: ruedasSelected ? '#07E607' : '#fff'}}/>
                                        </View>
                                        <Text style={{ color: '#262626', fontFamily:'Poppins_700Bold', fontSize: fontWidth / 28}}>Ruedas</Text>
                                    </TouchableOpacity>

                                    <TouchableOpacity onPress={() => setDocumentosSelected(!documentosSelected)} style={{width:'100%', flexDirection:'row', alignItems:'center', marginBottom:15}}>
                                        <View style={{width:fontWidth/18, height: fontWidth/18, marginRight:10, borderWidth:2, borderColor:'#07E607', borderRadius:100, justifyContent:'center', alignItems:'center'}}>
                                            <View style={{width:fontWidth/28, height: fontWidth/28, borderRadius:100, backgroundColor: documentosSelected ? '#07E607' : '#fff'}}/>
                                        </View>
                                        <Text style={{ color: '#262626', fontFamily:'Poppins_700Bold', fontSize: fontWidth / 28}}>Documentos</Text>
                                    </TouchableOpacity>

                                    <TouchableOpacity onPress={() => setEspejosSelected(!espejosSelected)} style={{width:'100%', flexDirection:'row', alignItems:'center', marginBottom:15}}>
                                        <View style={{width:fontWidth/18, height: fontWidth/18, marginRight:10, borderWidth:2, borderColor:'#07E607', borderRadius:100, justifyContent:'center', alignItems:'center'}}>
                                            <View style={{width:fontWidth/28, height: fontWidth/28, borderRadius:100, backgroundColor: espejosSelected ? '#07E607' : '#fff'}}/>
                                        </View>
                                        <Text style={{ color: '#262626', fontFamily:'Poppins_700Bold', fontSize: fontWidth / 28}}>Espejos</Text>
                                    </TouchableOpacity>

                                    <TouchableOpacity onPress={() => setExtintorSelected(!extintorSelected)} style={{width:'100%', flexDirection:'row', alignItems:'center', marginBottom:15}}>
                                        <View style={{width:fontWidth/18, height: fontWidth/18, marginRight:10, borderWidth:2, borderColor:'#07E607', borderRadius:100, justifyContent:'center', alignItems:'center'}}>
                                            <View style={{width:fontWidth/28, height: fontWidth/28, borderRadius:100, backgroundColor: extintorSelected ? '#07E607' : '#fff'}}/>
                                        </View>
                                        <Text style={{ color: '#262626', fontFamily:'Poppins_700Bold', fontSize: fontWidth / 28}}>Extintor</Text>
                                    </TouchableOpacity>

                                    <TouchableOpacity onPress={() => setFocosSelected(!focosSelected)} style={{width:'100%', flexDirection:'row', alignItems:'center', marginBottom:15}}>
                                        <View style={{width:fontWidth/18, height: fontWidth/18, marginRight:10, borderWidth:2, borderColor:'#07E607', borderRadius:100, justifyContent:'center', alignItems:'center'}}>
                                            <View style={{width:fontWidth/28, height: fontWidth/28, borderRadius:100, backgroundColor: focosSelected ? '#07E607' : '#fff'}}/>
                                        </View>
                                        <Text style={{ color: '#262626', fontFamily:'Poppins_700Bold', fontSize: fontWidth / 28}}>Focos</Text>
                                    </TouchableOpacity>

                                    {/* Campo de texto para Obs */}
                                    <View style={{width:'100%', flexDirection:'row', alignItems:'center', marginBottom:15}}>
                                        <Text style={{ color: '#262626', fontFamily:'Poppins_700Bold', fontSize: fontWidth / 28, marginRight: 10}}>Obs:</Text>
                                        <TextInput
                                            style={{
                                                borderColor: '#07E607',
                                                borderWidth: 2,
                                            ...
                                            onChangeText={text => setObsText(text)}  // Asigna el valor a un estado
                                            value={obsText}  // Estado para almacenar el texto ingresado
                                        />
                                    </View>
                                    ...
                                    <LinearGradient style={{width:'100%', height:50, borderRadius:10, marginTop:25, justifyContent:'center', alignItems:'center'}} colors={['#E6F14B', '#E6F14B', '#C3FE70']} start={{ x: 1, y: 0 }} end={{ x: 0, y: 0 }}>
                                            ...
                                            <TouchableOpacity onPress={() => cargarViajeGrua()} style={{width:'100%', height:'100%', justifyContent:'center', alignItems:'center'}} activeOpacity={1} >
...
export default CargaViajeGruaScreen;
