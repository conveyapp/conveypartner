...
// create a component
const CargaViajeLargoEspecialScreen = ({route, navigation}) => {
  const socket = getSocket();
    ...
    React.useEffect(() => {
        const unsubscribe = navigation.addListener('focus', async () => {
            var userToken = await AsyncStorage.getItem('Key_27');
            VistoCamionero()
            fetchCargaViajeLargoEspecial(userToken)
            chatExist(userToken)
            //connectScoket()
    ...
    fetchCargaViajeLargoEspecial = async (x) => {
      console.log('ixx')
      console.log(idCarga)
        await fetch(`${ServidorExport}/partner/viajelargoespecial/TraerCargaUnicaViajeLargoEspecial.php`, {
           method: 'POST',
           headers: {
      ...
      const VistoCamionero = () =>{
        ...
        fetch(`${ServidorExport}/partner/viajelargoespecial/MarcarVistoPago.php`, {
          method: 'POST',
          headers: {
              Accept: "application/json",
      ...
      const cargarViajeLargo = () =>{
        ...
        fetch(`${ServidorExport}/partner/viajelargoespecial/CargarViajeLargoEspecial.php`, {
          method: 'POST',
          headers: {
              Accept: "application/json",
              "Content-Type": "multipart/form-data"
      ...
      const EntregarCarga = async () =>{
        ...
        fetch(`${ServidorExport}/partner/viajelargoespecial/EntregarViajeLargoEspecial.php`, {
          method: 'POST',
          headers: {
              Accept: "application/json",
              "Content-Type": "multipart/form-data"
...
export default CargaViajeLargoEspecialScreen;
