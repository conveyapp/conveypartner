...
const CrearViajeCortoEspecialScreen = ({ route, navigation }) => {
  ...
  const [circleRadiusKm, setCircleRadiusKm] = React.useState(1);
  ...
  CrearViaje = async () => {
    ...
    var fueraciudadSend;
    if (fueraciudad == true) {
      fueraciudadSend = 'true'
    } else {
      fueraciudadSend = 'false'
    }
    ...
    fetch(`${ServidorExport}/partner/viajecortoespecial/CrearViajeCortoEspecial.php`, {
      method: 'POST',
      headers: {
        ...
        <ScrollView style={{ flex: 1 }} keyboardShouldPersistTaps='always'>
          ...
          <View style={{ flex: 1, width: '100%', marginTop: 2, paddingHorizontal: 15, backgroundColor: 'transparent' }}>
            ...
            <TouchableOpacity onPress={() => setFueraciudad(!fueraciudad)} style={{ width: '100%', flexDirection: 'row', alignItems: 'center', marginBottom: 15 }}>
              ...
              <Text style={{ color: '#262626', fontFamily: 'Poppins_700Bold', fontSize: fontWidth / 28 }}>Acepto traslados fuera de la ciudad</Text>
            </TouchableOpacity>
...
export default CrearViajeCortoEspecialScreen;
