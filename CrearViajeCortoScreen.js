...
const CrearViajeCortoScreen = ({ route, navigation }) => {
  ...
  CrearViaje = async () => {
    ...
    console.log(InfoUser.tokenpartner)



    fetch(`${ServidorExport}/partner/viajecorto/CrearViajeCorto.php`, {
      method: 'POST',
      headers: {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      <View style={styles.containerAdornos}>
        ...
        {/* ScrollView para todo el contenido visible */}
        <ScrollView
          style={{ flex: 1 }}
        ...
        >
          ...
          {/* Checkbox frío */}
          <TouchableOpacity onPress={() => setRefri(!refri)} style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
            <View
              style={{
                width: fontWidth / 18,
                height: fontWidth / 18,
            ...
            >
              <View
                style={{
                  ...
                  height: fontWidth / 28,
                  borderRadius: 100,
                  backgroundColor: refri ? '#07E607' : '#fff',
                }}
              />
            </View>
            <Text style={{ color: '#262626', fontFamily: 'Poppins_700Bold', fontSize: fontWidth / 28 }}>
              Vehículo con equipo de frío
            </Text>
          </TouchableOpacity>
...
export default CrearViajeCortoScreen;
