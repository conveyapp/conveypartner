...
const CrearViajeGruaScreen = ({ route, navigation }) => {
  ...
  CrearViaje = async () => {
    ...
    fetch(`${ServidorExport}/partner/viajegrua/CrearViajeGrua.php`, {
      method: 'POST',
      headers: {
...
export default CrearViajeGruaScreen;
