...
const DetalleViajeCortoEspecialScreen = ({ route, navigation }) => {
  ...
  DeleteViaje = () => {
    ...
    fetch(`${ServidorExport}/partner/BorrarViajeCortoEspecial.php`, {
      method: 'POST',
      headers: {
  ...
  React.useEffect(() => {
    const unsubscribe = navigation.addListener('focus', async () => {
      ...
      fetchCargasViajeCortoEspecial(userToken)
  ...
  fetchCargasViajeCortoEspecial = async (x) => {
    await fetch(`${ServidorExport}/partner/viajecortoespecial/TraerCargasViajeCortoEspecial.php`, {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
          ...
          <View style={{ flex: 1, width: '100%', marginTop: 2, paddingHorizontal: 10, backgroundColor: 'transparent' }}>
            ...
            {/* 
              <View style={{paddingHorizontal:15, paddingVertical:10, borderRadius:10, backgroundColor:'#07E607', alignSelf:'flex-start',}}>
                    <Text style={{ color: '#343434', fontFamily:'Poppins_700Bold', fontSize: fontWidth / 30,}}>Viaje corto especial</Text>
                  </View> */}
            ...
            <View style={{ width: '100%', paddingHorizontal: 0, }}>
              <TouchableOpacity onPress={() => navigation.navigate('EditViajeCortoEspecial', { InfoUser: InfoUser, InfoViaje: InfoViaje })} style={{ width: '100%', alignSelf: 'center', justifyContent: 'space-between', backgroundColor: '#fff', padding: 8, borderRadius: 10, shadowColor: "#000", shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5, }}>
...
export default DetalleViajeCortoEspecialScreen;
