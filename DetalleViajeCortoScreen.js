...
import { StyleSheet, Dimensions, Text, View, Image, ScrollView, TouchableWithoutFeedback, Platform, Keyboard, Alert, KeyboardAvoidingView, TouchableOpacity, Animated, ActivityIndicator, StatusBar } from 'react-native';
...
const DetalleViajeCortoScreen = ({ route, navigation }) => {
  ...
  DeleteViaje = () => {
    ...
    fetch(`${ServidorExport}/partner/BorrarViajeCorto.php`, {
      method: 'POST',
      headers: {
  ...
  React.useEffect(() => {
    const unsubscribe = navigation.addListener('focus', async () => {
      ...
      fetchCargasViajeCorto(userToken)
  ...
  fetchCargasViajeCorto = async (x) => {
    await fetch(`${ServidorExport}/partner/viajecorto/TraerCargasViajeCorto.php`, {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    ...
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      <View style={styles.containerAdornos}>
        ...
        <ScrollView style={{ flex: 1 }} keyboardShouldPersistTaps='always'>
          ...
          <View style={{ flex: 1, width: '100%', marginTop: 2, paddingHorizontal: 10, backgroundColor: 'transparent' }}>


            {/* <Text style={{ color: '#313131', fontFamily:'Poppins_700Bold', fontSize: fontWidth / 25, marginTop:25, marginBottom:15}}>Información del viaje</Text> */}
            ...
            <View style={{ width: '100%', height: fontWidth * 1.2, marginTop: 15, marginBottom: 10, borderRadius: 15, overflow: 'hidden' }}>
              <MapView
                style={{ flex: 1 }}
            ...
            <View style={{ width: '100%', paddingHorizontal: 0, }}>
              <TouchableOpacity onPress={() => navigation.navigate('EditViajeCorto', { InfoUser: InfoUser, InfoViaje: InfoViaje })} style={{ width: '100%', alignSelf: 'center', justifyContent: 'space-between', backgroundColor: '#fff', padding: 8, borderRadius: 10, shadowColor: "#000", shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5, }}>
                {/* <Text>Viaje corto</Text> */}
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fff' }}>
                  ...
                  <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text style={{ color: '#262626', fontFamily: 'Poppins_700Bold', fontSize: fontWidth / 25, marginLeft: 5, }}>Santiago</Text>
                  </View>

                  <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end' }}>
                    <Text style={{ color: '#262626', fontFamily: 'Poppins_700Bold', fontSize: fontWidth / 25, marginRight: 10 }}>{InfoViaje[0].radio}Km</Text>
...
export default DetalleViajeCortoScreen;
