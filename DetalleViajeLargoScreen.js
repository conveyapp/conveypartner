...
const DetalleViajeLargoScreen = ({ route, navigation }) => {
  ...
  DeleteViaje = () => {
    ...
    fetch(`${ServidorExport}/partner/BorrarViajeLargo.php`, {
      method: 'POST',
      headers: {
  ...
  React.useEffect(() => {
    const unsubscribe = navigation.addListener('focus', async () => {
      ...
      fetchCargasViajeLargo(userToken)
  ...
  fetchCargasViajeLargo = async (x) => {
    await fetch(`${ServidorExport}/partner/TraerCargasViajeLargo.php`, {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
export default DetalleViajeLargoScreen;
