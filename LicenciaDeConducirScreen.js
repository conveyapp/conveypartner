...
// create a component
const LicenciaDeConducirScreen = ({route, navigation}) => {
    ...
    React.useEffect(() => {
      ...
      fetchLicencia = async (x) => {
        await fetch(`${ServidorExport}/partner/TraerLicencia.php`, {
           method: 'POST',
           headers: {
        ...
        if(load == true){
          ...
          return ( 
            <View>
              ...
              <TouchableOpacity 
                onPress={() => { 
                  navigation.navigate('AddLicencia'); 
                }} 
                style={{
                  width: '100%', 
              ...
              >
                ...
                />
                <Text style={styles.txtRenderElements}>Agregar licencia</Text>
              </TouchableOpacity>
              ...
              {dataSource.map((data, i) => {
                return (
                  ...
                  >
                      <Image 
                        source={{ uri: `https://www.convey.cl/partner/licenciaimgs/${data.anverso}` }} 
            ...
            return(
               <View style={styles.ctnnoparse}>
                        <TouchableOpacity onPress={() => {navigation.navigate('AddLicencia')}} style={{width:'100%', backgroundColor:'#ededed', borderRadius:10, paddingVertical:25, justifyContent:'center', alignItems:'center'}}>
      ...
      DeleteAsk = (id) =>{
        ModalOptions('Alerta', '¿Eliminar?', '¿Estás seguro quieres eliminar la licencia?', () => DeleteLicencia(id));
      }
      DeleteLicencia = (id) =>{
        console.log(id)
        console.log(user)
        ...
        <View style={{ flex: 1, backgroundColor:'#fff' }}>
            ...
            <ScrollView style={{flex:1}} keyboardShouldPersistTaps='always'>
              ...
              <View style={styles.header}>
               ...
               <Text style={styles.TextHeader}>Licencia de conducir</Text>
...
export default LicenciaDeConducirScreen;
