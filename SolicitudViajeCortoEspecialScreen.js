...
// create a component
const SolicitudViajeCortoEspecialScreen = ({ route, navigation }) => {
  ...
  fetchSol = async () => {
    await fetch(`${ServidorExport}/partner/viajecortoespecial/TraerSolDetalle.php`, {
      method: 'POST',
      headers: {
  ...
  EnviarCot = () => {
    ...
    if (precio == '') {
      ...
      fetch(`https://www.convey.cl/partner/viajecortoespecial/EnviarCotizacion.php`, {
        method: 'POST',
        headers: {
          Accept: "application/json",
...
export default SolicitudViajeCortoEspecialScreen;
