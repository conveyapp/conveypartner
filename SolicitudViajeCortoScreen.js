...
// create a component
const SolicitudViajeCortoScreen = ({ route, navigation }) => {
  ...
  fetchSol = async () => {
    await fetch(`${ServidorExport}/partner/viajecorto/TraerSolDetalle.php`, {
      method: 'POST',
      headers: {
  ...
  EnviarCot = () => {
    ...
    if (precio == '') {
      ...
      fetch(`https://www.convey.cl/partner/viajecorto/EnviarCotizacion.php`, {
        method: 'POST',
        headers: {
          Accept: "application/json",
...
export default SolicitudViajeCortoScreen;
