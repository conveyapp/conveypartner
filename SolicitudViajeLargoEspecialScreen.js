...
// create a component
const SolicitudViajeLargoEspecialScreen = ({ route, navigation }) => {
  ...
  fetchSol = async () => {
    await fetch(`${ServidorExport}/partner/viajelargoespecial/TraerSolDetalle.php`, {
      method: 'POST',
      headers: {
  ...
  EnviarCot = () => {
    ...
    if (precio == '') {
      ...
      fetch(`https://www.convey.cl/partner/viajelargoespecial/EnviarCotizacion.php`, {
        method: 'POST',
        headers: {
          Accept: "application/json",
...
export default SolicitudViajeLargoEspecialScreen;
