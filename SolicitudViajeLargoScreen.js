...
// create a component
const SolicitudViajeLargoScreen = ({ route, navigation }) => {
  ...
  fetchSol = async () => {
    await fetch(`${ServidorExport}/partner/viajelargo/TraerSolDetalle.php`, {
      method: 'POST',
      headers: {
  ...
  EnviarCot = () => {
    ...
    if (precio == '') {
      ...
      fetch(`https://www.convey.cl/partner/viajelargo/EnviarCotizacion.php`, {
        method: 'POST',
        headers: {
          Accept: "application/json",
...
export default SolicitudViajeLargoScreen;
